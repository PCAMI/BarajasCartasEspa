 ...
 * @author kamil
 */
public class BarajaCartasEspañolas {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Cartas disponibles: " + barajaService.cartasDisponibles());
        barajaService.siguienteCarta();
        barajaService.siguienteCarta();
        barajaService.siguienteCarta();
        System.out.println("Cartas disponibles: " + barajaService.cartasDisponibles());
        barajaService.cartasMonton();
        barajaService.darCartas(5);
        barajaService.darCartas(35);
    }
}
